...
Script Purpose:
	...
	It ensures that the transformed data meets expected quality standards
	before being used for downstream processes such as analytics or loading
	into the gold layer.

	The script performs checks such as:
	- Detecting NULL or missing values in critical columns
	- Identifying duplicate records
	- Validating data formats and ranges (e.g., dates, numeric values)
